...
) : BaseSuspendedUseCase<PostStudentCreateUseCase.CreateStudent, GotStudentLobbyResponseSealed>() {

    override suspend fun invoke(param: CreateStudent): GotStudentLobbyResponseSealed =
